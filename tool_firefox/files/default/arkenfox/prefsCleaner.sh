...
## This file has been taken from the official repo at
## https://github.com/arkenfox/user.js/blob/master/prefsCleaner.sh
## and slightly modified to not change the current working directory.
## This is necessary to make it work with Salt `cmd.script`.
## @TODO PR with option to skip
